...
#---
[].method.grep /^re/  # => [:replace, :reject, :reject!, :respond_to? ......
#---

# テストが失敗したのは、既存のArray#replace()を上書きしてしまっていたから。
# 安易なパッチ = モンキーパッチ
# モンキーパッチは便利だが、危険なものでもある。

# 1.2.2の問題のコードはArray#replace()をArray#substitute()に改名することで対応。
